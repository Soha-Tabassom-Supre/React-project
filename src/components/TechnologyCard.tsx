...
export default function TechnologyCard({
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
      ...
      <button
        type="button"
        className="mt-5 w-full rounded-full bg-gradient-to-r from-orange-500 via-pink-500 to-violet-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:opacity-90"
      >
        Add to Stack
      </button>
    </div>
